...
echo ======================================================================
echo   Assetto Corsa Mod Organizer - Single-File Standalone Builder
echo ======================================================================
echo.
...
taskkill /F /IM ACModOrganize.exe /IM ACModOrganizer.exe /IM ACBO.exe /IM acbo_tests.exe >nul 2>&1
...
echo.
echo [4/4] Bundling standalone single-file dist\ACModOrganizer.exe...
...
echo.
echo ======================================================================
echo   SUCCESS! Standalone single executable ready at: dist\ACModOrganizer.exe
echo   Upload dist\ACModOrganizer.exe directly to your GitHub Release!
echo ======================================================================
echo.
